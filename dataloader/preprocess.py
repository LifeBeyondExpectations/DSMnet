...
def myaugment_color(normalize=__imagenet_stats):
    t_list = [
        ColorJitter(
            brightness=0.4,
            contrast=0.4,
...
def mypreprocess0(normalize=__imagenet_stats, augment=False):
    if(augment): return mypreprocess_color(normalize)
    t_list = [
        transforms.ToTensor(),
        #transforms.Normalize(**normalize)
    ]
...
def mypreprocess_color(normalize=__imagenet_stats):
    t_list = [
        transforms.ToTensor(),
        ColorJitter(
            brightness=0.4,
